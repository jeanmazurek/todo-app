...
import { Card, CardBody, CardHeader, Divider, CircularProgress } from "@heroui/react";
...
// Componente para a mensagem quando não há tarefas
...
export default function StatsPage() {
    ...
    const loadStats = () => {
        ...
        try {
            // Importação dinâmica do serviço de tarefas apenas no cliente
            import("@/services/todoService").then((module) => {
                const todoService = module.default;
                ...
                console.log("Estatísticas carregadas:", basicStats);
                console.log("Total de tarefas:", basicStats.total);
                ...
                console.error("Erro ao importar o todoService:", err);
                setError("Erro ao carregar o serviço de tarefas.");
                setLoading(false);
            });
        } catch (err) {
        ...
        if (!isClient) {
            return (
                <div className="flex flex-col items-center justify-center py-12">
                    <CircularProgress aria-label="Inicializando..." className="mb-4" />
                    <p className="text-default-500">Inicializando...</p>
                </div>
            );
        }
        ...
        <div className="flex flex-col items-center gap-12 py-12 px-6 md:py-16 md:px-10">
            <div className="text-center max-w-3xl">
                ...
                <h2 className={subtitle({ className: "mt-4" })}>
                    Visualize métricas e padrões para melhorar sua produtividade
                </h2>
            </div>
